...
class Properties extends Component {
    ...
    render() {
        return (<div class="properties" id="properties" onMouseUp={this.propertiesonMouseUp.bind(this)} onMouseOver={this.propertiesonMouseOver.bind(this)} onMouseDown={this.propertiesonMouseDown.bind(this)} onMouseMove={this.propertiesonMouseMove.bind(this)} style={this.state.style}>{this.props.children}
